...
class ScMenu(ScBase):
	...
	def __init__(self, pCTX, pRender, pWanem):
		...
		self.ptDef.insert(0, self.CreateTocuhDef("BtPreset", 429,      210, 81, 81, self.BtHandler))
		self.ptDef.insert(1, self.CreateTocuhDef("BtDirect", 348,      210, 81, 81, self.BtHandler))
		#self.ptDef.insert(2, self.CreateTocuhDef("BtReplay", 434-204,  95, 180, 132, self.BtHandler))
		if self.pCTX.apiStatus == 0: 
			self.ptDef.insert(2, self.CreateTocuhDef("BtReplay",  434-204,  95, 180, 50, self.BtHandler))			
		self.ptDef.insert(3, self.CreateTocuhDef("BtInit",    468,      29,   62, 42,  self.BtHandler))
		self.ptDef.insert(4, self.CreateTocuhDef("BtSetting", 434-204,  233, 180, 50, self.BtHandler))
		self.ptDef.insert(5, self.CreateTocuhDef("BtRemote",  434-204,  164, 180, 50, self.BtHandler))
	...
	def Start(self):
		...
		self.pRender.fb.putstr(48+22+5, 120+80-50, "WAN Emulate by manual", c, 1)	
		...
		self.pRender.fb.putstr   (baseX+22+menuLabelPosXOffset,  baseY+7, menuLabel, c, 2)
		c = self.pRender.ConvRgb(0.92,0.2, 1.0-disabledDiff)
		self.pRender.fb.putstr   (baseX+22+3-10,    baseY+34, "Reproduce by recorded DAT", c, 1)	
		...
		self.pRender.fb.putstr   (baseX+22+3-10+5,    baseY+34, "Contorl from Remote CLI", c, 1)	
		...
		self.pRender.fb.draw.rect(c, Rect(48+10+204, 120+20+115+4, 160, 16), 0)
		c = self.pRender.ConvRgb(0.32,0.4,0.2)
		self.pRender.fb.draw.rect(c, Rect(48+204, 120+20+115+25, 180, 10), 0)		
		self.pRender.fb.putstr(48+22+204, 120+26-3+110-16, "  Setting  ", c, 2)
		c = self.pRender.ConvRgb(0.32,0.2, 1.0)
		self.pRender.fb.putstr(48+22+3+204+10, 120+80+64, "Check Wanem Config", c, 1)	
