...
class ScManual(ScBase):
	...
	def __init__(self, pCTX, pRender, pWanem):
		...
		self.ptDef.insert(1, self.CreateTocuhDef("BtConnL",  208 - 90*0, 100 + 80*0, 80, 48, self.BtHandler))
		self.ptDef.insert(2, self.CreateTocuhDef("BtConnR",  208 - 90*1, 100 + 80*0, 80, 48, self.BtHandler))
		self.ptDef.insert(3, self.CreateTocuhDef("BtSpeedL", 208 - 90*0, 100 + 80*1, 80, 48, self.BtHandler))
