...
class ScManualEx(ScBase):
	...
	def __init__(self, pCTX, pRender, pWanem):
		...
		self.ptDef.insert(4,  self.CreateTocuhDef("BtUpBand1L",    477, 158, 40,  26, self.BtHandler))
		self.ptDef.insert(5,  self.CreateTocuhDef("BtUpBand1R",    405, 158, 40,  26, self.BtHandler))
		self.ptDef.insert(6,  self.CreateTocuhDef("BtUpBand10L",   477, 158+30*1, 40, 26, self.BtHandler))
		self.ptDef.insert(7,  self.CreateTocuhDef("BtUpBand10R",   405, 158+30*1, 40, 26, self.BtHandler))
		self.ptDef.insert(8,  self.CreateTocuhDef("BtUpBand100L",  477, 158+30*2, 40, 26, self.BtHandler))
		self.ptDef.insert(9,  self.CreateTocuhDef("BtUpBand100R",  405, 158+30*2, 40, 26, self.BtHandler))
		self.ptDef.insert(10, self.CreateTocuhDef("BtDwBand1L",    368, 158, 40,  26, self.BtHandler))
		self.ptDef.insert(11, self.CreateTocuhDef("BtDwBand1R",    368-72, 158, 40,  26, self.BtHandler))
		self.ptDef.insert(12, self.CreateTocuhDef("BtDwBand10L",   368,    158+30*1, 40, 26, self.BtHandler))
		self.ptDef.insert(13, self.CreateTocuhDef("BtDwBand10R",   368-72, 158+30*1, 40, 26, self.BtHandler))
		self.ptDef.insert(14, self.CreateTocuhDef("BtDwBand100L",  368,    158+30*2, 40, 26, self.BtHandler))
		self.ptDef.insert(15, self.CreateTocuhDef("BtDwBand100R",  368-72, 158+30*2, 40, 26, self.BtHandler))
		self.ptDef.insert(16, self.CreateTocuhDef("BtUpDelay1L",   258,    158, 40,  26, self.BtHandler))
		self.ptDef.insert(17, self.CreateTocuhDef("BtUpDelay1R",   258-72, 158, 40,  26, self.BtHandler))
		self.ptDef.insert(18, self.CreateTocuhDef("BtUpDelay10L",  258,    158+30*1, 40, 26, self.BtHandler))
		self.ptDef.insert(19, self.CreateTocuhDef("BtUpDelay10R",  258-72, 158+30*1, 40, 26, self.BtHandler))
		self.ptDef.insert(20, self.CreateTocuhDef("BtUpDelay100L", 258,    158+30*2, 40, 26, self.BtHandler))
		self.ptDef.insert(21, self.CreateTocuhDef("BtUpDelay100R", 258-72, 158+30*2, 40, 26, self.BtHandler))
		self.ptDef.insert(22, self.CreateTocuhDef("BtDwDelay1L",   144,    158, 40,  26, self.BtHandler))
		self.ptDef.insert(23, self.CreateTocuhDef("BtDwDelay1R",   144-72, 158, 40,  26, self.BtHandler))
		self.ptDef.insert(24, self.CreateTocuhDef("BtDwDelay10L",  144,    158+30*1, 40, 26, self.BtHandler))
	...
	def BtHandler(self, key):
		...
		if key == "BtMenu":
			...
			if self.isApply != 0:
				self.pWanem.EmuDisconnToggleMini(self.upBand, self.dwBand, self.upDelay, self.dwDelay)
		elif key == "BtConnR":
			if self.isApply != 0:
	...
	def RenderParamForm(self, idx, label, value, unit, isParamOnly = False):
		...
		self.pRender.fb.draw.rect(c, Rect(116*idx + 16*1,     100+40, 100, 2), 0)
		self.pRender.fb.draw.rect(c, Rect(116*idx + 16*1,     100,    2,   40), 0)
		self.pRender.fb.draw.rect(c, Rect(116*idx + 16*1+100, 100,    2,   42), 0)

		c = self.pRender.W;
		self.pRender.fb.putstr(116*idx + 16*1+33,   152+30*0,   " 1",  c, 2)
		self.pRender.fb.putstr(116*idx + 16*1+33+6, 152+30+1,   "10",  c, 2)
		self.pRender.fb.putstr(116*idx + 16*1+33,   152+30*2,   "100",  c, 2)

		c = self.pRender.ConvRgb(0.44,0.9,0.7);
		self.pRender.fb.draw.rect(c, Rect(116*idx + 16*1,    146+30*0,  30, 26), 0)
		self.pRender.fb.draw.rect(c, Rect(116*idx + 16*1+72, 146+30*0,  30, 26), 0)
		self.pRender.fb.draw.rect(c, Rect(116*idx + 16*1,    146+30*1,  30, 26), 0)
		self.pRender.fb.draw.rect(c, Rect(116*idx + 16*1+72, 146+30*1,  30, 26), 0)
		self.pRender.fb.draw.rect(c, Rect(116*idx + 16*1,    146+30*2,  30, 26), 0)
		self.pRender.fb.draw.rect(c, Rect(116*idx + 16*1+72, 146+30*2,  30, 26), 0)
